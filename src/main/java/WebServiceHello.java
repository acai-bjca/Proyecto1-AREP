...
public class WebServiceHello {
    ...
    public static String square() {
        String html = "<!DOCTYPE html>\n"
                ...
                + "    <h5 class=\"masthead-heading mb-0\" style=\"color: #0056b3; font-size: 3.2em\">Inicio</h5>\n"
                + "    <br>\n"
    ...
    public static String square(String num) {
        ...
        String html = "<!DOCTYPE html>\n"
                ...
                + "\n"
                + "<body style=\"background-color: #a6e1ec\">\n"
                + "    <h5 class=\"masthead-heading mb-0\" style=\"color: #0056b3; padding:0; font-size: 3.2em\">Cuadrado</h5>"
                + "    <h4 class=\"masthead-heading mb-0\" style=\"padding-left: 50px; font-size: 1.2em\">"+numI +"²  =  "+numI*numI+"</h5>"
                + "    <br>\n" 
                + "</body>\n"
                + "\n"
                + "</html>";
